...
class Analysis():
    ...
    def add_node(self, node_tag, x, y, z):
        ...
        node_object = ud3d1el.node.Node(node_tag, x, y, z)
    ...
    def add_element(self, ele_tag, i_tag, j_tag,A,Ayy,Azz,Iy,Iz,J,E,v=0.3,beta=0):
        ...
        element_object = ud3d1el.element.Element(ele_tag,i_node,j_node,A,Ayy,Azz,Iy,Iz,J,E,v,beta)
